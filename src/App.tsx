...
const Navbar = ({ theme, setTheme }: { theme: Theme, setTheme: (t: Theme) => void }) => {
            ...
            {isOpen && (
              <>
                ...
                <motion.div
                  ...
                  className="absolute right-0 mt-2 w-40 glass rounded-2xl p-2 shadow-2xl border border-white/20 dark:border-white/10 overflow-hidden"
                >
                  {themes.map((t) => (
                    <button
                      key={t.id}
...
const Hero = () => (
  <section className="min-h-screen flex items-center section-padding pt-32 relative overflow-hidden bg-white dark:bg-neutral-950 transition-colors duration-300">
    ...
    <div className="absolute top-1/4 -left-20 w-96 h-96 bg-emerald-400/10 rounded-full blur-[120px] pointer-events-none" />
    <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-blue-400/10 rounded-full blur-[120px] pointer-events-none" />
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center w-full relative z-10">
      ...
      >
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20 text-emerald-700 dark:text-emerald-400 text-[10px] font-black uppercase tracking-[0.2em] mb-8 animate-float">
          <Zap size={14} /> Disponible pour nouveaux projets
        </div>
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-[0.9] text-neutral-900 dark:text-white">
          Baraka <br />
        ...
        <p className="text-xl md:text-2xl text-neutral-500 dark:text-neutral-400 mb-10 max-w-xl leading-relaxed font-medium">
          Étudiant en Pharmacie (L3) à l'Université Officielle de Bukavu, passionné par la fusion entre la <span className="text-neutral-900 dark:text-neutral-100">santé</span> et la <span className="text-emerald-600">technologie</span>.
        </p>
        <div className="flex flex-wrap gap-6">
          <a 
            href="#contact" 
            className="px-10 py-5 bg-neutral-900 dark:bg-emerald-600 text-white rounded-2xl font-bold hover:bg-emerald-600 dark:hover:bg-emerald-700 transition-all flex items-center gap-3 shadow-[0_20px_50px_rgba(16,185,129,0.3)] hover:-translate-y-1 active:scale-95"
          >
            Me contacter <ChevronRight size={20} />
          </a>
          <a 
            href="#projects" 
            className="px-10 py-5 border-2 border-neutral-200 dark:border-neutral-800 rounded-2xl font-bold hover:bg-neutral-100 dark:hover:bg-neutral-900 text-neutral-900 dark:text-neutral-100 transition-all hover:-translate-y-1 active:scale-95"
          >
            Voir mes projets
          </a>
          <a 
            ...
            className="px-6 py-5 border-2 border-neutral-200 dark:border-neutral-800 rounded-2xl font-bold hover:bg-blue-50 dark:hover:bg-blue-500/10 hover:border-blue-500 hover:text-blue-600 transition-all hover:-translate-y-1 active:scale-95 flex items-center justify-center text-neutral-600 dark:text-neutral-400"
      ...
      >
        <div 
          className="relative z-10 w-full aspect-[3/4] rounded-[3rem] md:rounded-[5rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.2)] border-[12px] md:border-[24px] border-white dark:border-neutral-900 bg-neutral-100 dark:bg-neutral-800 bg-cover bg-center group overflow-hidden"
        ...
        <motion.div 
          ...
          className="absolute -bottom-6 -left-4 md:-bottom-10 md:-left-10 p-4 md:p-8 glass rounded-3xl md:rounded-[2.5rem] z-20 border border-white/20 dark:border-white/10"
        >
          <div className="flex items-center gap-3 md:gap-5">
            ...
            <div>
              <p className="text-[10px] md:text-xs text-neutral-400 dark:text-neutral-500 uppercase font-black tracking-[0.2em] mb-0.5 md:mb-1">Spécialité</p>
        ...
        <motion.div 
          ...
          className="absolute top-10 -right-4 md:-right-10 p-4 md:p-6 glass rounded-2xl md:rounded-3xl z-20 border border-white/20 dark:border-white/10"
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[8px] md:text-[10px] text-neutral-400 dark:text-neutral-500 uppercase font-black tracking-[0.2em]">Secteur</p>
  ...
  <section id="about" className="section-padding bg-neutral-100 dark:bg-neutral-900 transition-colors duration-300 relative overflow-hidden">
    ...
    <div className="grid md:grid-cols-2 gap-16 items-center relative z-10">
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 text-[10px] font-black uppercase tracking-widest mb-6">
          <Stethoscope size={14} /> Qui suis-je ?
        </div>
        <h2 className="text-4xl md:text-5xl font-black mb-8 tracking-tight leading-tight text-neutral-900 dark:text-white">
      ...
      <div className="relative">
        <div 
          className="aspect-[4/5] rounded-[3rem] md:rounded-[4rem] bg-neutral-100 dark:bg-neutral-800 border-[12px] md:border-[24px] border-white dark:border-neutral-900 shadow-2xl flex items-center justify-center overflow-hidden relative group bg-cover bg-center"
        ...
        >
          ...
          <div className="absolute bottom-4 left-4 md:bottom-10 md:left-10 p-6 md:p-10 glass rounded-[2rem] md:rounded-[2.5rem] shadow-2xl z-10 max-w-[220px] md:max-w-xs border border-white/20 dark:border-white/10">
            ...
            <code className="text-xs md:text-lg font-mono text-emerald-950 dark:text-emerald-100 leading-relaxed">
...
const SkillCard = ({ icon: Icon, title, description, skills }: { icon: any, title: string, description: string, skills: string[] }) => (
  <div className="p-10 bg-white dark:bg-neutral-900 rounded-[2.5rem] border border-neutral-200 dark:border-neutral-800 hover:border-emerald-500 hover:shadow-[0_20px_50px_rgba(0,0,0,0.05)] transition-all duration-500 group relative overflow-hidden">
    ...
    <div className="w-16 h-16 rounded-2xl bg-emerald-50 dark:bg-emerald-500/10 flex items-center justify-center text-emerald-600 dark:text-emerald-400 mb-8 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
      <Icon size={32} />
    </div>
    <h3 className="text-2xl font-black mb-3 tracking-tight text-neutral-900 dark:text-white">{title}</h3>
    <p className="text-neutral-500 dark:text-neutral-400 text-sm mb-8 leading-relaxed font-medium">{description}</p>
    <div className="flex flex-wrap gap-2">
      {skills.map(skill => (
        <span key={skill} className="px-4 py-1.5 bg-neutral-50 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 text-[10px] font-black uppercase tracking-widest rounded-full border border-neutral-100 dark:border-neutral-700 group-hover:border-emerald-200 dark:group-hover:border-emerald-500/30 transition-colors">
          {skill}
        </span>
      ))}
    </div>
  ...
  <section className="section-padding bg-neutral-50 dark:bg-neutral-950 transition-colors duration-300 relative overflow-hidden">
    ...
    <div className="grid md:grid-cols-2 gap-20 items-center relative z-10">
      <div className="order-2 md:order-1">
        ...
        <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter leading-[0.9] text-neutral-900 dark:text-white">
        ...
        <div className="grid gap-6">
          {[
            ...
            >
              <div className="p-4 bg-emerald-50 dark:bg-emerald-500/10 rounded-2xl text-emerald-600 dark:text-emerald-400">
                <item.icon size={28} />
              </div>
              <div>
                <h4 className="text-lg font-black mb-1 text-neutral-900 dark:text-white">{item.title}</h4>
      ...
      <div className="order-1 md:order-2">
        <div className="relative group">
          ...
          <div 
            className="aspect-square rounded-[3rem] md:rounded-[5rem] bg-neutral-100 dark:bg-neutral-800 overflow-hidden shadow-2xl relative z-10 border-[12px] md:border-[24px] border-white dark:border-neutral-900 bg-cover bg-center"
...
const Skills = () => {
  ...
  return (
    <section id="skills" className="section-padding bg-white dark:bg-neutral-950 transition-colors duration-300">
      <div className="text-center max-w-2xl mx-auto mb-16">
        <h2 className="text-3xl font-black mb-4 text-neutral-900 dark:text-white">Mes Compétences</h2>
        <p className="text-neutral-500 dark:text-neutral-400 mb-8 font-medium">Un aperçu des technologies que j'apprends et utilise pour construire des applications modernes.</p>
...
const Vision = () => (
  <section className="section-padding bg-emerald-600 dark:bg-emerald-700 text-white overflow-hidden relative transition-colors duration-300">
...
const TimelineItem = ({ year, title, institution, description }: { year: string, title: string, institution: string, description: string }) => (
  <div className="relative pl-12 pb-16 border-l-2 border-neutral-100 dark:border-neutral-800 last:pb-0">
    ...
    <span className="inline-block px-3 py-1 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 text-[10px] font-black uppercase tracking-widest rounded-full mb-4 border border-emerald-100 dark:border-emerald-500/20">
      {year}
    </span>
    <h3 className="text-2xl font-black mb-2 tracking-tight text-neutral-900 dark:text-white">{title}</h3>
  ...
  <section id="education" className="section-padding bg-white dark:bg-neutral-950 transition-colors duration-300 relative overflow-hidden">
    ...
    <div className="grid lg:grid-cols-3 gap-20 relative z-10">
      <div className="lg:col-span-1">
        ...
        <h2 className="text-4xl md:text-5xl font-black mb-8 tracking-tighter leading-tight text-neutral-900 dark:text-white">Parcours <br /><span className="text-emerald-600">Académique</span></h2>
        ...
        <div className="p-8 bg-neutral-50 dark:bg-neutral-900 rounded-[2.5rem] border border-neutral-100 dark:border-neutral-800">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i}>
                <div className="flex justify-between text-sm font-bold mb-2 text-neutral-900 dark:text-neutral-100">
                  <span>{lang.name}</span>
    ...
    <section id="projects" className="section-padding bg-neutral-100 dark:bg-neutral-900 transition-colors duration-300 relative">
      <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
        <div className="max-w-2xl">
          ...
          <h2 className="text-4xl md:text-6xl font-black mb-6 tracking-tighter text-neutral-900 dark:text-white">Projets & <span className="text-emerald-600">Réalisations</span></h2>
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer" 
          className="group px-8 py-4 bg-white dark:bg-neutral-800 rounded-2xl font-bold border border-neutral-200 dark:border-neutral-700 flex items-center gap-3 hover:bg-emerald-600 hover:text-white transition-all duration-300 text-neutral-900 dark:text-neutral-100"
        >
      ...
      <div className="grid md:grid-cols-2 gap-12">
        {projects.map((project, i) => (
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-emerald-50 dark:bg-emerald-500/10 flex items-center justify-center text-emerald-600 dark:text-emerald-400 mb-8">
              <project.icon size={32} />
            </div>
            <h3 className="text-3xl font-black mb-4 tracking-tight text-neutral-900 dark:text-white">{project.title}</h3>
...
const Contact = () => (
  <section id="contact" className="section-padding bg-neutral-50 dark:bg-neutral-950 transition-colors duration-300 relative overflow-hidden">
    ...
    <div className="max-w-6xl mx-auto glass rounded-[4rem] p-12 md:p-24 text-center relative z-10 border border-white/20 dark:border-white/10">
      <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 text-[10px] font-black uppercase tracking-widest mb-8">
        <Send size={14} /> Contact
      </div>
      <h2 className="text-5xl md:text-7xl font-black mb-8 tracking-tighter leading-tight text-neutral-900 dark:text-white">Travaillons <br /><span className="text-emerald-600">ensemble</span></h2>
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
        <a 
          ...
          className="group flex flex-col items-center p-10 rounded-[3rem] bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 hover:border-emerald-500 hover:shadow-2xl transition-all duration-500"
        >
          <div className="w-20 h-20 rounded-3xl bg-emerald-50 dark:bg-emerald-500/10 flex items-center justify-center text-emerald-600 dark:text-emerald-400 mb-6 group-hover:scale-110 transition-transform">
            <Mail size={36} />
          </div>
          <span className="text-xs font-black text-neutral-400 dark:text-neutral-500 uppercase tracking-[0.2em] mb-2">Email</span>
          <span className="text-lg font-bold break-all text-neutral-900 dark:text-white">barakamichaelklg@gmail.com</span>
        </a>
        <a 
          href="tel:0979307569" 
          className="group flex flex-col items-center p-10 rounded-[3rem] bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 hover:border-emerald-500 hover:shadow-2xl transition-all duration-500"
        >
          ...
          <span className="text-xs font-black text-neutral-400 dark:text-neutral-500 uppercase tracking-[0.2em] mb-2">Téléphone</span>
          <span className="text-2xl font-black text-neutral-900 dark:text-white">0979307569</span>
        </a>
      </div>
      <div className="mt-20 flex flex-wrap justify-center gap-8">
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="group p-5 rounded-3xl bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 hover:bg-emerald-600 hover:text-white transition-all duration-300 flex items-center gap-4 shadow-sm text-neutral-900 dark:text-neutral-100"
        >
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="group p-5 rounded-3xl bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 hover:bg-[#0A66C2] hover:text-white transition-all duration-300 flex items-center gap-4 shadow-sm text-neutral-900 dark:text-neutral-100"
        >
...
const Footer = () => (
  <footer className="bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 section-padding transition-colors duration-300 border-t border-neutral-100 dark:border-neutral-800 relative overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto relative z-10">
      <div className="grid md:grid-cols-2 gap-20 items-start mb-24 text-left">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-100 dark:bg-neutral-800 text-neutral-500 dark:text-neutral-400 text-[10px] font-black uppercase tracking-widest mb-8">
            Ressources
          </div>
          <h2 className="text-3xl font-black mb-8 tracking-tighter text-neutral-900 dark:text-white">Vérification des Photos</h2>
        ...
        <div className="md:text-right">
          <div className="text-5xl font-black mb-6 tracking-tighter text-neutral-900 dark:text-white">
            BARAKA<span className="text-emerald-600">.DEV</span>
          </div>
          <p className="text-xl text-neutral-500 dark:text-neutral-400 font-medium mb-4">© {new Date().getFullYear()} Tous droits réservés.</p>
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-neutral-50 dark:bg-neutral-800 border border-neutral-100 dark:border-neutral-800 text-neutral-400 text-xs italic font-medium">
            Fait avec passion à Bukavu, RDC.
          </div>
        </div>
      </div>
      <div className="pt-12 border-t border-neutral-100 dark:border-neutral-800 text-center">
        <p className="text-sm font-black uppercase tracking-[0.3em] text-neutral-300 dark:text-neutral-600">
